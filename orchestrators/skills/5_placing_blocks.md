...
- Call `place_block` with the reference block's coordinates and the face direction (e.g., `face_y=1` to place it on top of the reference block). Wait for `[SYSTEM EVENT: placementCompleted]`.
